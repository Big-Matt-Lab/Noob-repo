#!/usr/bin/python
"""
Randomly generate a password from a list of words
Credit to Scott M Sullivan"""
...
def args():
    parser = argparse.ArgumentParser(
        description="Randomly generate a password from a list of words"
    )
    parser.add_argument(
        "-n",
        "--num",
        help="Number of words to generate. Defaults to 5.",
        type=int,
        default=5,
    )
